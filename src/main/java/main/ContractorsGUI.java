...
public class ContractorsGUI extends javax.swing.JFrame {
    ...
    private void removeButtonClick(java.awt.event.ActionEvent evt) {                                   
        ContractorsContainer.removeContractor( contractorsList);
    }                                  

    private void editButtonClick(java.awt.event.ActionEvent evt) {                                 
    ...
    private void saveEditButtonClick(java.awt.event.ActionEvent evt) {                                     
        resetFormColor();
